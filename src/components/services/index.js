...
const WebApplications = () => {
    ...
    const scrollTo = props => {
      ...
      const webFaq = [
        ...
        {
            question: `What makes Adrenalize web apps so fast?`,
        ...
        <div className="flex flex-col md:flex-row md:p-4">
          <div className="flex flex-col my-4 md:w-1/2 md:pr-4">
            ...
            <p className="m-1 md:my-auto text-base">
              <strong>Simply put, Adrenalize web apps were born to sell.</strong>
            </p>
          </div>
...
const MobileApplications = () => {
  ...
  const mobileFaq = [
    ...
    },
    {
      ...
      answer: <p>Installing a Adrenalize smart application is just as easy as installing any other app! Upon publishing, Adrenalize mobile applications can be installed and updated by users via the Google Play Store (Android), the Apple Store (iOS) or SDK.</p>,
      jsonAnswer:`<p>Installing a Adrenalize smart application is just as easy as installing any other app! Upon publishing, Adrenalize mobile applications can be installed and updated by users via the Google Play Store (Android), the Apple Store (iOS) or SDK.</p>`
  },
  {
    question: `How is my app data managed?`,
    answer: <p>Every Adrenalize mobile application is managed via a custom built, integrated management tool, where clients can manage their app cloud databases, appearance, and configuration settings.</p>,
    jsonAnswer:`<p>Every Adrenalize mobile application is managed via a custom built, integrated management tool, where clients can manage their app cloud databases, appearance, and configuration settings.</p>`
},
{
...
const DesktopApplications = () => {
  ...
  const desktopFaq = [
    {
        question: `Do Adrenalize desktop applications work on all operating systems?`,
        answer: <p>Yes! We package each Adrenalize desktop application with an installer for all modern Windows, Mac or Linux operating systems, and can custom tailor each installation package to your needs.</p>,
        jsonAnswer:`Yes! We package each Adrenalize desktop application with an installer for all modern Windows, Mac or Linux operating systems, and can custom tailor each installation package to your needs.`
    },
    {
